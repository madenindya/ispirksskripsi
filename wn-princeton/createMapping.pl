...
open (IN, "./../00-data/wn-31/index.noun.modif");

open (OUT1, ">./../00-data/seed/en/n-n/lemma_hyponym.txt");
open (OUT2, ">./../00-data/seed/en/n-n/lemma_memberMeronym.txt");
open (OUT3, ">./../00-data/seed/en/n-n/lemma_substanceMeronym.txt");
open (OUT4, ">./../00-data/seed/en/n-n/lemma_partMeronym.txt");
...
sub create_hyponymRel {
	...
	open (IN2, "./../00-data/wn-31/data.noun.modif");
...
sub print_offsetToSynset {
	open (OUT, ">./../00-data/seed/en/offset-mapping/offset_synset.txt");
...
sub print_hyponymRel {
	open (OUT, ">./../00-data/seed/en/offset-mapping/offset_hyponymRel.txt");
...
sub print_memberMeronymRel {
	open (OUT, ">./../00-data/seed/en/offset-mapping/offset_memberMeronymRel.txt");
...
sub print_substanceMeronymRel {
	open (OUT, ">./../00-data/seed/en/offset-mapping/offset_substanceMeronymRel.txt");
...
sub print_partMeronymRel {
	open (OUT, ">./../00-data/seed/en/offset-mapping/offset_partMeronymRel.txt");
